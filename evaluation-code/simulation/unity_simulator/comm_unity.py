    ...
    for vid_mod in image_syn:
        subprocess.call(['ffmpeg', '-i',
                        #  '{}/Action_%04d_{}.png'.format(vid_folder, vid_mod), 
                         os.path.join(vid_folder, 'Action_%04d_{}.png'.format(vid_mod)),
                         '-framerate', str(frame_rate),
                         '-pix_fmt', 'yuv420p',
                        #  '{}/Action_{}.mp4'.format(vid_folder, vid_mod)])
                         os.path.join(vid_folder, 'Action_{}.mp4'.format(vid_mod))])
        # files_delete = glob.glob('{}/Action_*_{}.png'.format(vid_folder, vid_mod))
        # files_delete = glob.glob(os.path.join(vid_folder, 'Action_*_{}.png'.format(vid_mod)))
